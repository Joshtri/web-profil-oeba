    ...
    <Layout>
        ...
        <div className="container mt-4">
            ...
            <table className="table table-bordered text-center">
                ...
                <tr>
                    <td>14</td>
                    <td>G. P. NITBANI, SH</td>
                    <td>LURAH</td>
                    <td>Oktober 2004 – 10 April 2007</td>
                </tr>
                {/* * data ke-15 */}
                <tr>
                    <td>15</td>
                    <td>SETH F. MESAH</td>
                    <td>LURAH</td>
                    <td>10 April 2007 – 15 Oktober 2009</td>
                </tr>
                {/* * data ke-16 */}
                <tr>
                    <td>16</td>
                    <td>G. P. NITBANI, SH</td>
                    <td>LURAH</td>
                    <td>15 Oktober 2009 – Maret 2012</td>
                </tr>
                {/* * data ke-17 */}
                <tr>
                    <td>17</td>
                    <td>SETH F. MESAH</td>
                    <td>LURAH</td>
                    <td>Maret 2012 – Oktober 2014</td>
                </tr>
                {/* * data ke-18 */}
                <tr>
                    <td>18</td>
                    <td>JAMES MAUSI, S. Sos</td>
                    <td>LURAH</td>
                    <td>Oktober 2014 – September 2021</td>
                </tr>
                {/* * data ke-19 */}
                <tr>
                    <td>19</td>
                    <td>LEONARD MESAH, S. Sos</td>
                    <td>LURAH</td>
                    <td>September 2021 – Sekarang</td>
                </tr>
                </tbody>
            </table>
            </div>
